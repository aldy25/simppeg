...
<body class="fixed-left">
    ...
    <div id="wrapper">
        ...
        <div class="left side-menu">
            ...
            <!-- LOGO -->
            <div style="margin-top: 50px; margin-bottom:30px;" class="topbar-left m-b-5">
                <div class="text-center">
                    <a href="<?= base_url() ?>/Beranda" class="logo">PT Unggul Rejowasono</a>
                            ...
                            <li class="list-inline-item dropdown notification-list">
                                ...
                                <a class="nav-link dropdown-toggle arrow-none waves-effect nav-user" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                    ...
                                    <span style="color: dimgray;" class="mr-2 d-none d-lg-inline text-gray-600 small">
                                        Welcome!, <?= $row->nama ?></span>
                                    <img src="<?= base_url() ?>/assets/images/profil/<?= $row->foto ?>" alt="user" class="rounded-circle">
                                </a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 style="font-weight: 600;" class="page-title">SISTEM INFORMASI PENERIMAAN PEGAWAI
                                        BARU
                                    </h4>
                                </div>
