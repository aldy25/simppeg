...
class Modaldatahistori extends Model
{
    ...
    function __construct(RequestInterface $request)
    {
        ...
        $this->dt = $this->db->table($this->table)->where('status', 'Ditolak')->orWhere('status', 'Diterima')->join('tbl_lowongan', 'lowongan=id_lowongan');
    }
