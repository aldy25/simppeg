...
class Modaldataseleksi extends Model
{
    ...
    function __construct(RequestInterface $request)
    {
        ...
        $this->dt = $this->db->table($this->table)->where('status', 'Terkirim')->orWhere('status', 'Diproses')->join('tbl_lowongan', 'lowongan=id_lowongan');
    }
